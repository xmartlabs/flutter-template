...
description: Orchestrates dependency and toolchain maintenance for this Flutter repo — auditing pub packages and SDK/build-tool pins, gating proposed updates behind safety verification, and applying/opening PRs only after explicit human go-ahead. Use for "audit dependencies," "check for outdated packages," "is it safe to bump X," "update the Flutter SDK," "check for security advisories," or "run the dependency maintenance pipeline."
model: sonnet
effort: high
