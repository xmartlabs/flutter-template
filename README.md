...
Another important plugin related to the UI is the [flutter_screenutil][flutter_screenutil], used for adapting screen and font size.
...
The repository pattern is used to to manage the data layer.
