...
class CustomColors extends ThemeExtension<CustomColors> {
  ...
  static CustomColors getCustomColors() => const CustomColors(
    textColor: MaterialColor(0xff414158, <int, Color>{
    ...
    info: MaterialColor(0xff1169f7, <int, Color>{
    ...
    success: MaterialColor(0xff8ec144, <int, Color>{
    ...
    warning: MaterialColor(0xffffbf00, <int, Color>{
    ...
    danger: MaterialColor(0xfff4642c, <int, Color>{
