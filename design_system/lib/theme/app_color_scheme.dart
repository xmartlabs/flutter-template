...
class AppColorScheme extends ColorScheme {
  ...
  static AppColorScheme getDefaultColorScheme() => AppColorScheme(
    colorScheme: ColorScheme.fromSeed(
      ...
      seedColor: const MaterialColor(0xffee1a64, <int, Color>{
      ...
      error: const MaterialColor(0xfff4642c, <int, Color>{
    ...
    primary: const MaterialColor(0xffee1a64, <int, Color>{
      100: Color(0xfffff2f6),
      200: Color(0xfffcc7da),
      300: Color(0xfffa9ebe),
      400: Color(0xfff5558d),
    ...
    onPrimary: const MaterialColor(0xff414158, <int, Color>{
    ...
    secondary: const MaterialColor(0xffffd81d, <int, Color>{
    ...
    surface: const MaterialColor(0xfff7fafd, <int, Color>{
      100: Color(0xffffffff),
    ...
    onSurface: const MaterialColor(0xff5b5b5b, <int, Color>{
      100: Color(0xffffffff),
      200: Color(0xffadadad),
      300: Color(0xff5b5b5b),
      400: Color(0xff1e1e1e),
